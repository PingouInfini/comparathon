...
args_list = ["keywords", "keywords_from_file", "prefix_keywords", "suffix_keywords",
             ...
             "output_directory", "metadata_directory", "image_directory", "no_directory", "proxy", "similar_images", "specific_site",
    ...
    def download_image(self,image_url,image_format,main_directory,dir_name, image_name, count,print_urls,socket_timeout,prefix,print_size,no_numbering,no_download):
        ...
        try:
            ...
            try:
                ...
                # keep only alphanum characters in filename + lower case
